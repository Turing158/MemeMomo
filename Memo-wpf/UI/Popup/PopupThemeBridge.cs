...
{
    internal const string BackgroundKey = "Memo.Popup.Background";
    internal const string BorderKey = "Memo.Popup.Border";
    internal const string ForegroundKey = "Memo.Popup.Foreground";
