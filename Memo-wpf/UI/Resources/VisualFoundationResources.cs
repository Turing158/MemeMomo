...
public static class VisualFoundationResources
{
    ...
    [
        ...
        "ChevronDownIcon", "MemoIcon", "MarkdownToolbarMenuCheckIcon", "MarkdownTableEdgeButtonTheme",
    ...
    public static void EnsureLoaded(System.Windows.Application application)
    {
        ...
        {
            Source = new Uri("/Memo;component/Resources/Foundation.xaml", UriKind.RelativeOrAbsolute)
        });
    }
