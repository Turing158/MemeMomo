...
/// intentionally opt-in so production continues to use %AppData%\Memo while
/// isolated acceptance/rehearsal processes can never touch a user's data.
/// </summary>
internal static class MemoDataPaths
{
    internal const string AppDataOverrideVariable = "MEMO_APPDATA_DIR";
    ...
    internal static string RootDirectory
    {
        get
        {
            ...
            return Path.Combine(appData, "Memo");
        }
    }
}
